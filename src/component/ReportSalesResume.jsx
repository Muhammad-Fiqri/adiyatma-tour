import "../css/ReportSalesResume.scss";
import Table from 'rc-table';

function ReportSalesResume() 
{
    const columns = [
        {
            title: 'NO',
    ...
    return(
        <div className="ReportSalesResume-wrapper">
            <h2>Sales Report Resume</h2>
...
export default ReportSalesResume;